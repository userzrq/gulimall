...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
    ...
    public List<MemberReceiveAddressEntity> getAddressesByMemberId(Long memberId) {
        List<MemberReceiveAddressEntity> receiveAddressList
                = memberReceiveAddressDao.selectList(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id", memberId));
