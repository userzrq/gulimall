...
public class AttrGroupController {
    ...
    public Resp<PageVo> getCatelogAttrGroups(QueryCondition condition,@PathVariable("catId") Long catId){
        PageVo pageVo = attrGroupService.queryPageAttrGroupsByCatId(condition,catId);
